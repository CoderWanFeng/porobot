...
porobot 是快速调用腾讯云AI平台功能的接口合集。

``porobot``所有功能的实现，都依托于腾讯云的文字识别，如果是小白用户，可以**扫码下图，免费开通**~
...
```
pip install -i https://mirrors.aliyun.com/pypi/simple/ porobot -U
```
...
-  💻所有功能的列表👉[点我直达](https://www.python-office.com/video/porobot.html)


## 常见问题

1. 如何配置porobot-config.toml？
...
porobot欢迎任何人来添砖加瓦，贡献代码，建议提交的pr（pull request）符合一些规范，规范如下：
